...
Public Class ReportYear
    ...
    Private Sub reportYear_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        Dim sql As String
        sql = "SELECT month(Orders.Job_Date) AS job_month ,SUM(Orders.Job_Price) AS job_sum FROM Orders  WHERE Orders.Job_Status='ชำระแล้ว' GROUP BY month(Orders.Job_Date)"
