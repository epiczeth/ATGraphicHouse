...
Partial Public Class CustomerJob
    ...
    Private Function Validation() As Boolean
        If cbCusID.Text <> "" AndAlso cbCusName.Text <> "" AndAlso cbJobType.SelectedIndex <> -1 AndAlso nudCount.Value <> 0 AndAlso nudHeight.Value <> 0 AndAlso txtJobID.Text <> "" AndAlso txtjobtitle.Text <> "" AndAlso nudPrice.Value <> 0 AndAlso nudWidth.Value <> 0 AndAlso cbStatus.SelectedIndex <> -1 Then
            Return True
        Else
            Return False
        End If
    ...
    Private Sub Fill_dataGridView()
        ...
        Dim sql As String = "SELECT Orders.Job_Id, Orders.Job_Name, Orders.Job_Class, Orders.Job_Num, Orders.Job_Size, Orders.Job_Price, Orders.Job_Date, Orders.Job_Sent, Orders.Job_Script, Customer.Cus_Name, Employee.Emp_Name,"
        ...
        Else
            ...
            sql &= "FROM ((Orders INNER JOIN "
            sql &= " Employee ON Orders.Emp_Id = Employee.Emp_Id) INNER JOIN "
            sql &= "Customer ON Orders.Cus_Id = Customer.Cus_Id) WHERE Customer.Cus_Id=" & Convert.ToInt32(cbCusID.SelectedValue) & " ORDER BY Orders.Job_Id"
        End If
        Try
        ...
        Dim header() As String = {"รหัสงาน", "ชื่อ", "ประเภท", "จำนวน", "ขนาด", "ราคา", "วันรับงาน", "วันส่งงาน", "หมายเหตุ", "ชื่อลูกค้า", "ชื่อพนักงาน", "สถานะ"}
        For i As Integer = 0 To dgv.ColumnCount - 1
    ...
    Private Sub CheckPrice()
        ...
        If cbJobType.SelectedIndex <> -1 And nudWidth.Value <> 0 And nudHeight.Value <> 0 And SimulateIsNumeric.IsNumeric(nudWidth.Value) And SimulateIsNumeric.IsNumeric(nudHeight.Value) And SimulateIsNumeric.IsNumeric(nudCount.Value) And nudCount.Value <> 0 Then
    ...
    Private Sub cbCusName_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cbCusName.SelectedIndexChanged
    ...
    Private Sub cbJobType_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cbJobType.SelectedIndexChanged
        checkPrice()
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button3.Click
        If dgv.SelectedRows.Count <> -1 Then
            If MessageBox.Show(Me, "คุณต้องการลบ '" & dgv.SelectedRows(0).Cells(1).Value.ToString() & "' ออกจากฐานข้อมูลใช่หรือไม่?", "ลบข้อมูล", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = DialogResult.Yes Then
                If CInt(_con.query("DELETE FROM Orders WHERE Job_Id=" & dgv.SelectedRows(0).Cells(0).Value.ToString() & "")) >= 1 Then
    ...
    Private Sub Button4_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button4.Click
        If dgv.SelectedRows.Count > -1 Then
            ...
            nudCount.Value = dgv.SelectedCells(3).Value.ToString()
    ...
    Private Sub CheckBox2_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBox2.CheckedChanged
        If nudPrice.Value <> 0 And bypass = False Then
