...
Public Class FrmBillList
    ...
    Private Sub fill_dgv()
        Try
            ...
            If ComboBox1.SelectedValue.ToString() <> "System.Data.DataRowView" Then
                ...
                Dim sql As String = "SELECT Job_Id, Job_Class, Job_Num, Job_Price FROM Orders WHERE Cus_Id=" & Convert.ToInt32(ComboBox1.SelectedValue.ToString()) & " AND (Job_Status='ค้างชำระ' OR Job_Status='มัดจำ 50%')"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For i As Integer = 0 To DataGridView1.Rows.Count - 1
            ...
            End If
        Next
        FrmBill.Cus_id = Convert.ToInt32(ComboBox1.SelectedValue)
        FrmBill.Query = sql
        FrmBill.queryb = sql2
