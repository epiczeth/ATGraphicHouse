...
Partial Public Class MdiParent1
    ...
    Private Sub ToolStripLabel1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ToolStripLabel1.Click
        If MessageBox.Show("คุณต้องการออกจากระบบหรือไม่", "ออกจากระบบ?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            Application.Restart()
        End If
    End Sub
    ...
    Private Sub MDIParent1_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles MyBase.FormClosing
        Application.Exit()
    End Sub
End Class